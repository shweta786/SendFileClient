 ...
 * generated in the com.hiber.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _Download_QNAME = new QName("http://service.hiber.com/", "download");
    private final static QName _DownloadResponse_QNAME = new QName("http://service.hiber.com/", "downloadResponse");
    private final static QName _Upload_QNAME = new QName("http://service.hiber.com/", "upload");
    private final static QName _UploadResponse_QNAME = new QName("http://service.hiber.com/", "uploadResponse");
    private final static QName _UploadImageBytes_QNAME = new QName("", "imageBytes");
    private final static QName _DownloadResponseReturn_QNAME = new QName("", "return");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.hiber.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.hiber.com/", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.hiber.com/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.hiber.com/", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.hiber.com/", name = "uploadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "imageBytes", scope = Upload.class)
    public JAXBElement<byte[]> createUploadImageBytes(byte[] value) {
        return new JAXBElement<byte[]>(_UploadImageBytes_QNAME, byte[].class, Upload.class, ((byte[]) value));
    }
